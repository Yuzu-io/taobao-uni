declare namespace UniCloudNamespace {
    ...
    type UniCloud = UniCloudInterface;
...
interface UniCloud {
     ...
     */
    init(options: UniCloudNamespace.UniCloudOptions): UniCloudNamespace.UniCloud;
    /**
     * 获取登录对象
     *
     ...
     */
    customAuth(): UniCloudNamespace.Auth;
    /**
     * 调用云函数
     *
     ...
     */
    callFunction(options: UniCloudNamespace.CallFunctionOptions): Promise<any>;
    /**
     * 引用云对象
     *
     * 文档: [http://uniapp.dcloud.io/uniCloud/cloud-obj](http://uniapp.dcloud.io/uniCloud/cloud-obj)
     */
    importObject(objectName: string, importObjectOptions?: UniCloudNamespace.ImportObjectOptions): any;
    /**
     * 上传文件到云端
     *
     * 文档: [http://uniapp.dcloud.io/uniCloud/storage?id=uploadfile](http://uniapp.dcloud.io/uniCloud/storage?id=uploadfile)
     */
    uploadFile(options: UniCloudNamespace.UploadFileOptions): Promise<any>;
    /**
     * 选择并上传文件
     *
     ...
     */
    getCurrentUserInfo(): UniCloudNamespace.LocalUserInfo;
    /** 事件回调 */
    ...
    */
    onResponse(callback: (result: UniCloudNamespace.UniCloudResponseEvent) => void): void
    /** 
    ...
    */
    offResponse(callback: (result: UniCloudNamespace.UniCloudResponseEvent) => void): void
...
type UniCloudInterface = UniCloud;
